...
exports.login = async (req, res, next) => {
    ...
    if (!existingCustomer) {
        return res
            .status(400)
            .json({
                message: `Customer with this email ${email} has no account !`,
            });
    }
...
exports.filteredMaxLikedComment = async (req, res, next) => {
    ...
    const maxLikedComment = await Likes.getMaxLikedCommentForProduct(product_id);
